namespace Tekla.Technology.Akit.UserScript
{
    ...
    public class Script
    {
        ...
        /// </summary>
        const string ApplicationName = "ReferenceModelScale.exe";
    ...
    public static class LaunchExternalApplication
    {
        ...
        public static void Run(string applicationName, IScript akit)
        {
            ...
            {
                Structures.Model.Operations.Operation.DisplayPrompt("XSBIN Variable not found, failed to launch application.");
                return;
            }
            ...
            if (!appDir.Exists)
            {
                Structures.Model.Operations.Operation.DisplayPrompt(appDir.FullName + " directory does not exist, failed to launch application");
                return;
            }
            ...
            if (!appFiles.Any())
            {
                Structures.Model.Operations.Operation.DisplayPrompt(appDir.FullName + " file does not exist, failed to launch application");
                return;
            }
        ...
        private static void StartExtension(string filePath)
        {
            ...
            if (externalApplication.Start()) Structures.Model.Operations.Operation.DisplayPrompt(filePath + " successfully started.");
            else Structures.Model.Operations.Operation.DisplayPrompt(filePath + " unable to be started.");
        }
    }
}