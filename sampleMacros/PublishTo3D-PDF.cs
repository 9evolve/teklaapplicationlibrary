...
namespace Tekla.Technology.Akit.UserScript
{
    public class Script
    {
        public static void Run(Tekla.Technology.Akit.IScript akit)
        {
            ...
            string ApplicationName = "PublishTo3DPDF.exe";
            string ApplicationPath = Path.Combine(TSBinaryDir, "Environments\\common\\extensions\\PublishTo3DPDF\\" + ApplicationName);
